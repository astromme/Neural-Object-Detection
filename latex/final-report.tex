...
\end{tabular}
\end{center}
\caption{Some examples of colors and their respective distances in the three colorspace models. R, G, B, S, V, L all vary between [0, 255]. Hue varies between [0, 360]. `Good' values are subjective, based on ideas on what colors are likely to be part of the same object in an image seen by the computer or robot.}
\label{tab:colorComparisons}
\end{table*}
}%

\subsection{gngviewer}

Because of the incremental nature of our modifications to the GNG we needed a reliable and sensible way of visualizing the results of the GNG. From this need the gngviewer emerged. The viewer is domain-specific, it assumes a GNG with inputs that contain pixel information. The viewer runs asynchronously from the GNG and provides a continuously updating view of how the GNG is changing. It provides layers that show the nodes along with their color information, the edges and the subgraphs that have been generated. The gngviewer is producing the images in the screenshots that follow.
...
\begin{figure}[h!]
  ...
  \subfigure[Categorization on one sheet.]{
    \includegraphics[width=0.40\textwidth]{paper1.png}
  }
  \subfigure[Categorization on two sheets.]{
    \includegraphics[width=0.40\textwidth]{paper2.png}
  }
  \subfigure[Categorization on three sheets.]{
    \includegraphics[width=0.40\textwidth]{paper3.png}
  }
  \subfigure[Categorization on four sheets. Space is poorly categorized.]{
    \includegraphics[width=0.40\textwidth]{paper4.png}
  }
...
\begin{figure}[h!]
  \centering
  \subfigure[Categorization after 10,000 steps. The beginnings of disjoint subgraphs are evident.]{
    \includegraphics[width=0.40\textwidth]{paper4_lowerror10000steps.png}
    \label{fig:paper4_10,000}
  }
  \subfigure[Categorization after 20,0000 steps. Space is fully categorized]{
    \includegraphics[width=0.40\textwidth]{paper4_lowerror20000steps.png}
