...
\end{tabular}
\end{center}
\caption{Some examples of colors and their respective distances in the three colorspace models. {\bf I`m not so sure about this wording.. thoughts? } `Good' values are subjective, based on the authors' ideas on what colors are likely to be part of the same object in an image seen by the computer or robot.}
\end{table*}
}%
